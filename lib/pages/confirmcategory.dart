...
class Confirmcategory extends StatefulWidget {
  ...
  @override
  State<Confirmcategory> createState() => _ConfirmcategoryState();
}

class _ConfirmcategoryState extends State<Confirmcategory> {
  ...
  Future<void> addDetails() async {
    ...
    try {
      var response = await http.post(
        Uri.parse("${mainurl}add_categories_details.php"),
        body: data,
      );
